                ...
                child: Column(
                  children: [
                    Flexible(
                      ...
                      child: Row(
                        children: [
                          ...
                          Flexible(flex: 2, child: Crono(seconds: _st.rawTime)),
                        ],
                      ),
                    ),
                    ...
                    Flexible(
                      ...
                      child: Row(
                        children: [
                          Flexible(flex: 4, child: Velocidad(v: point.getV())),
                          const VerticalDivider(width: 0, color: dividerColor),
                          Flexible(
                            flex: 3,
                            child: Column(
                              children: [
                                Expanded(
                                  child: VelocidadMax(v: trip.getVMax()),
                                ),
                                const Divider(height: 0, color: dividerColor),
                                Expanded(
                                  child: VelocidadAvg(v: trip.getVAvg()),
                                ),
                              ],
                            ),
                          ),
